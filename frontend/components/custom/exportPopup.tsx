		...
		<Dialog>
			...
			<DialogContent className="w-[calc(100%-2rem)] max-w-[calc(100%-2rem)] sm:max-w-lg">
				...
				<div className="grid gap-3">
					<Button
						variant="secondary"
						className={`h-auto w-full items-start justify-between rounded-lg border border-border border-l-4 bg-secondary px-3 py-3 text-left transition-colors hover:bg-secondary/90  sm:px-4 ${
							target === "image"
								? "border-l-primary border-primary/70"
								: "border-l-transparent"
						}`}
						onClick={() => setTarget("image")}
					>
						<div className="flex w-full flex-col items-start gap-1 text-left">
							<div className="flex sm:w-full w-1/2 flex-col items-start gap-1 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
								<p className="text-sm font-medium sm:text-base">Download Image</p>
								<span className="text-xs text-muted-foreground sm:text-sm">.png</span>
							</div>
					...
					<Button
						...
						<div className="flex w-full flex-col items-start gap-1 text-left">
							<div className="flex sm:w-full w-1/2 flex-col items-start gap-1 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
								...
								<span className="text-xs text-muted-foreground sm:text-sm">.zip</span>
							</div>
							<p className="text-xs text-muted-foreground sm:text-sm">
					...
					>
						<div className="flex sm:w-full flex-col items-start gap-1 text-left">
							<div className="flex w-full w-1/2 flex-col items-start gap-1 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
								<p className="text-sm font-medium sm:text-base">Download Report</p>
								<span className="text-xs text-muted-foreground sm:text-sm">.pdf</span>
							</div>
							<p className="text-xs text-muted-foreground sm:text-sm">
				...
				<DialogFooter className="flex-col-reverse gap-2 sm:flex-row sm:gap-3">
					...
					<Button className="w-full sm:w-auto" onClick={handleExport}>Start export</Button>
				</DialogFooter>
			</DialogContent>
		</Dialog>
	)
