  ...
  return (
    <div className="flex h-full flex-col bg-transparent">
      ...
      <div className="border-border flex items-center justify-between border-b px-4 py-2">
        ...
        <div>
          <Button
            ...
            onClick={() => setScreen((prev) => (prev === 'circuit' ? 'analysis' : 'circuit'))}
          >
            {svgscreen === 'circuit' ? (
          ...
          {isLoading ? (
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm">Loading circuit {circuitId}...</p>
              </div>
            </div>
          ) : svgContent ? (
            <div
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm">No circuit diagram available</p>
                <p className="text-muted-foreground mt-1 text-xs">Load a circuit to view SVG</p>
              </div>
            </div>
          )}
        </div>
      ...
      <div className="border-border flex items-center justify-between border-t px-4 py-2">
        <span className="text-muted-foreground text-xs">Zoom: {(zoom * 100).toFixed(0)}%</span>
